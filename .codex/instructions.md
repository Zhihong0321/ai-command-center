# AI Command Center — Codex Agent Protocol
...
1. Open the file `SKILL.md` located in the root directory of this repository.
2. Read **Section 3. The Mandatory Warm-Up Procedure**.
3. Execute Steps 1 through 5 of the procedure precisely as written. Do not skip any steps.

## Your Identity
When registering or sending heartbeats, use:
- `agent_type`: `CODEX`
- `machine_name`: set to a recognizable label for this machine
